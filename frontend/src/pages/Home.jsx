...
import jhumkaHero from "../assets/Jhumkeshwari_F.png";
  ...
  return (
    <>
      <section className="relative w-full h-[600px] bg-[#a87449] overflow-hidden group">
        <img 
          src={jhumkaHero} 
          alt="Jhumkeshwari Front Page Banner"
          className="w-full h-full object-cover object-left opacity-90 mix-blend-multiply transition-transform duration-700 hover:scale-105"
        />
        
        <button className="absolute left-6 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/30 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity">
          <ChevronLeft size={20} />
        </button>
        <button className="absolute right-6 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/30 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity">
